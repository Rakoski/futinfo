package br.com.backend.common.repositories;

import br.com.backend.common.entities.BaseEntity;
...
public interface BaseRepository<T extends BaseEntity, I>
        ...
        QuerydslBinderCustomizer<EntityPathBase<T>> {

    @Override
    default void customize(QuerydslBindings bindings, EntityPathBase<T> entity) {
